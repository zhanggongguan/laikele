...
public interface IIndexService {
	...
	public List<PromotionItem> selectPromotionItemByStore(long cityID);
	...
	public List<Brand> selectTopBrandByCity(long cityID);

	public List<Brand> selectTopBrandByZone(long zoneID);

...
public class UKBNOVCTCOrder {
    ...
    private String toflowfname;

    private String tirggerbatchnum;
    ...
    public void setToacctid(String toacctid) {
        this.toacctid = toacctid == null ? null : toacctid.trim();
    }
    ...
    public void setServiceaccountid(String serviceaccountid) {
        this.serviceaccountid = serviceaccountid == null ? null : serviceaccountid.trim();
    }
    ...
    public void setFlowmessage(String flowmessage) {
        this.flowmessage = flowmessage == null ? null : flowmessage.trim();
    }

    public String getToflowfname() {
        return toflowfname;
    }

    public void setToflowfname(String toflowfname) {
        this.toflowfname = toflowfname == null ? null : toflowfname.trim();
    }

    public String getTirggerbatchnum() {
        return tirggerbatchnum;
    }

    public void setTirggerbatchnum(String tirggerbatchnum) {
        this.tirggerbatchnum = tirggerbatchnum == null ? null : tirggerbatchnum.trim();
    }
